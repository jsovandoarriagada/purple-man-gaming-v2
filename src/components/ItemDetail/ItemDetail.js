      ...
      <div className="details__container">
        <div className="detail">
          ...
          <div className="detail__game-requirements">
            <p className="detail__game-requirements--title">
              GAME REQUIREMENTS
            </p>
            <hr />
            <div className="detail__requirements">
              <div className="detail__minimum">
                ...
                <p className="detail__minimum--os">
                  OS &mdash; {item.minimum.os}
                </p>
                <p className="detail__minimum--processor">
                  Processor &mdash; {item.minimum.processor}
                </p>
                <p className="detail__minimum--ram">
                  RAM &mdash; {item.minimum.ram}
                </p>
                <p className="detail__minimum--graphics">
                  Graphics &mdash; {item.minimum.graphics}
                </p>
                <p className="detail__minimum--disk">
                  Disk Space &mdash; {item.minimum.disk}
                </p>
                <p className="detail__minimum--directx">
                  Direct X &mdash; {item.minimum.directx}
                </p>
              </div>
              <div className="detail__recommended">
                <p className="detail__recommended--title">RECOMMENDED:</p>
                <p className="detail__recommended--os">
                  OS &mdash; {item.recommended.os}
                </p>
                <p className="detail__recommended--processor">
                  Processor &mdash; {item.recommended.processor}
                </p>
                <p className="detail__recommended--ram">
                  RAM &mdash; {item.recommended.ram}
                </p>
        ...
        <div className="extra">
          ...
          <div className="extra__info">
            ...
            <p className="extra__info--publisher">
              Publisher &mdash; {item.info.publisher}
            </p>
            <p className="extra__info--developer">
              Developer &mdash; {item.info.developer}
            </p>
            <p className="extra__info--age">
              Age Rating &mdash; {item.info.age}
            </p>
            <p className="extra__info--source">
              Source &mdash; {item.info.source}
            </p>
            <p className="extra__info--genres">
              Genres &mdash; {item.info.genres}
            </p>
            <p className="extra__info--released">
              Released &mdash; {item.info.released}
            </p>
            <p className="extra__info--languages">
              Languages &mdash; {item.info.languages}
            </p>
          </div>
        </div>
      </div>
